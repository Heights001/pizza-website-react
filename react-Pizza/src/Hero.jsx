...
const hero = () => {
  return (
    <div style={{ backgroundImage: `url(${bgimg})`}} className="bg-cover bg-center h-[30rem] flex items-center justify-center text-center px-4">
      <section class="bg-($url('pizza.jpg')] bg-cover bg-center h-[30rem] flex items-center justify-center text-center px-4 ">
